        ...
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-unstyled">
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Write a compelling title</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Set realistic target amount</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Add detailed description</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Upload high-quality image</li>
                    <li class="mb-2"><i class="fas fa-check text-success me-2"></i>Choose appropriate category</li>
                </ul>
            </div>
        </div>
    </div>
