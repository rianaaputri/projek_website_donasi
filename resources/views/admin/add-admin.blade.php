...
<body>
  ...
  <div class="sidebar">
    ...
    <div class="sidebar-logout">
      <a href="#" class="logout-btn"><i class="fas fa-sign-out-alt me-2"></i> Logout</a>
    </div>
  </div>
  ...
  <div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <div class="text-muted">{{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</div>
    </div>
            ...
            <form id="addAdminForm" method="POST" action="{{ route('admin.store-admin') }}">
              ...
              <div class="form-group">
                ...
                <div class="invalid-feedback">
                  @error('name') {{ $message }} @else Please provide a valid name. @enderror
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text" onclick="togglePassword('password')"><i class="fas fa-eye" id="togglePasswordIcon"></i></span>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-text" onclick="togglePassword('password_confirmation')"><i class="fas fa-eye" id="togglePasswordConfirmIcon"></i></span>
                </div>
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                <button type="button" class="btn btn-secondary me-md-2" onclick="window.history.back()"><i class="fas fa-arrow-left me-2"></i>Cancel</button>
                <button type="submit" class="btn btn-primary"><i class="fas fa-user-plus me-2"></i>Create Admin Account</button>
              </div>
            </form>
          </div>
        </div>
  ...
  <script>
    ...
    // PERBAIKAN: Simplifikasi JavaScript validation
    document.getElementById('addAdminForm').addEventListener('submit', function (e) {
      ...
      const passwordRegex = /^(?=.*\d).{6,}$/; // Minimal 6 karakter dengan 1 angka

      let isValid = true;

      // Reset classes
      [name, email, password, passwordConfirm].forEach(el => el.classList.remove('is-invalid', 'is-valid'));
      ...
      if (password.value !== passwordConfirm.value) {
        ...
        isValid = false;
      } else passwordConfirm.classList.add('is-valid');

      // Jika tidak valid, prevent submit
      if (!isValid) {
        e.preventDefault();
        showAlert('danger', 'Please fix the errors in the form and try again.');
        return false;
      }

      // Jika valid, biarkan form submit normal (hapus preventDefault dan manual submit)
      showAlert('info', 'Creating admin account...');
    });
